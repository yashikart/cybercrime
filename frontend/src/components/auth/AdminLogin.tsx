...
export function AdminLogin({ setCurrentPage }: AdminLoginProps) {
    ...
    <div className="flex items-center justify-center min-h-screen p-4">
      <div className="w-full max-w-md">
        ...
        <button
          ...
          className="flex items-center gap-2 text-gray-500 hover:text-red-400 transition mb-6 font-mono text-sm"
        >
                ...
                <div className="space-y-2 group/field">
                  ...
                  <div className="relative">
                    <Input
                      id="email"
                      type="email"
                      placeholder="admin@cybercrime.gov"
                      value={email}
